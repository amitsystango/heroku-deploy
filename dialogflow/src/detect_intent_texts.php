...
function detect_intent_texts($projectId, $texts, $sessionId, $languageCode = 'en-US')
{
    ...
    foreach ($texts as $text) {
        ...
        echo json_encode(array('Session' => $session_id, 'QueryText' => $queryText, 'IntentName' => $displayName, 'Confidence' => $confidence, 'FulfilmentText' => $fulfilmentText));
    }
